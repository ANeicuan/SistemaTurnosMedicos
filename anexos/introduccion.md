...
- RF1 El sistema debe crear,reprogramar y cancelar turnos de manera agil.
...
- RF9 Debe incluir entidades bien definidas para Paciente(Nombre,Telefono,ID), Profesional,Turno(Estado,fecha,hora,tipo) y registro de presencia.
...
- RNF7 El modelo debe manejar conceptos del dominio ("intervalos de tiempo", "disponibildad") de forma abstracta, no solo como datos técnicos o números sueltos, para reflejar fielmente el funcionamiento real del consultorio.
